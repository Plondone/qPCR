---
title: "Example analysis with technical replicates"
author: "Jordi Camps"
...
```{r}
list_bad_tech_rep(qpcr, treshold = 0.4)
```
...
```{r}
plot_scatter_per_gene(endog, gene = "Dcn", x.var = "Cell_type", y.var = "DCt", col.var = "Condition") 
```
...
```{r}
plot_scatter_per_gene(endog, gene = "Dcn", x.var = "Cell_type", y.var = "rel_expr", col.var = "Condition") 
```
